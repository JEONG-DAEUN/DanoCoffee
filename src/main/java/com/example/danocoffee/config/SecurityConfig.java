package com.example.danocoffee.config;
...
import com.example.danocoffee.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        System.out.println(passwordEncoder().encode("1111"));  // 처음 아이디 만들때 비밀번호 암호화 확인
    }
